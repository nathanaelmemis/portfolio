...
import { Box, Typography, Button, Select, MenuItem, FormControl, InputLabel, TextField, ImageList, ImageListItem, IconButton, Dialog, DialogTitle, DialogContent, DialogActions, DialogContentText } from "@mui/material";
...
function DeveloperDashboard() {
  ...
  async function handleOnClickDeleteConfirmDialogYes() {
    ...
    try {
      ...
      await axios.post('/api/delete_project', {
        idToken: idToken,
  ...
  async function handleOnClickSaveButton() {
    ...
    try {
      await axios.post('/api/save_project', projectDataToSend)
   ...
   * 
   * TODO: 
   * - add checking of file type, should only be images
   * 
   * */
